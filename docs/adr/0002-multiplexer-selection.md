...
- wktr never manages herdr workspaces. Windows are created as tabs in whatever workspace the user is in, which composes with organizing herdr as one workspace per repo without wktr owning that lifecycle.
